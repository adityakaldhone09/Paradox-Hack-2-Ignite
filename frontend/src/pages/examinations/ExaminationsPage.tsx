  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {exams.map((ex) => (
          <Card key={ex.id} hoverable className="p-5 border-slate-800 flex flex-col justify-between space-y-4">
            <div>
              ...
              <h3 className="text-base font-bold text-slate-100 mt-2">{ex.name}</h3>
              <p className="text-xs text-slate-400">{ex.department} • {ex.subject}</p>
              ...
              <div className="space-y-2 mt-4 pt-3 border-t border-slate-800/80 text-xs text-slate-300">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-[10px] px-2 py-0.5 rounded bg-slate-800 text-brand-400 border border-slate-700">
                    {ex.security_level}
                  </span>
                </div>
                <div className="flex justify-between items-center">
      ...
      <Modal isOpen={isCreateOpen} onClose={() => setIsCreateOpen(false)} title="Create New Examination">
        <form onSubmit={handleCreate} className="space-y-4 text-xs">
          <div>
            <label className="block font-semibold text-slate-300 mb-1">Examination Name *</label>
            <input
              type="text"
              required
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block font-semibold text-slate-300 mb-1">Exam Code / ID *</label>
              <input
                type="text"
                required
