    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {centres.map((c) => {
          ...
          return (
            <Card key={c.id} className="p-5 border-slate-800 space-y-4">
              ...
              <div className="pt-3 border-t border-slate-800 space-y-2">
                ...
                <div className="space-y-2 max-h-40 overflow-y-auto custom-scrollbar">
                  {centreDevices.map((d) => (
                    <div key={d.id} className="p-2 rounded bg-slate-950/80 border border-slate-800/80 flex items-center justify-between text-xs">
                      <div>
                        <span className="font-medium text-slate-200 block">{d.device_name}</span>
